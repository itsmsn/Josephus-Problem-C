...
void myRect(int x1, int y1, int x2, int y2, COLORREF lineColor, COLORREF fillColor,int k)
{
	...
	Rectangle(device_context, x1 + 650, (y1 + k), x2 + 650, y2 + k);
	DeleteObject(pen);
	DeleteObject(brush);
	ReleaseDC(console_handle, device_context);
}
...
void drawboard(int* arr, int size , int& s,int& k)
{
	cout << endl;
	int y, x;
	for (int i = 0; i < size; i++)
	{
		for (int j = 1; j <= 1; j++)
		{
			if (arr[i] == 1) {
				//x = ((i * 45) + ((i * 45) + 45));
					myRect(i * 25, s * 25, (i * 25) + 25, (j * 25) + 25, RGB(0, 0, 0), RGB(255, 0, 0),k);
			}
			else if (arr[i] == 2) {
				//x = ((i * 45) + ((i * 45) + 45));
				for (int a = 0; a < 10; a++)
				{
					myRect(i * 45, j * 45, (i * 45) + 45, (j * 45) + 45, RGB(0, 0, 0), RGB(3, 22, 166),k);
				}
			}
			else if (arr[i] == 0) {
				//x = ((i * 45) + ((i * 45) + 45));
					myRect(i * 25, s * 25, (i * 25) + 25, (j * 25) + 25, RGB(0, 0, 0), RGB(255, 255, 255),k);
			}
			else if (arr[i] == 4) {
				//x = ((i * 45) + ((i * 45) + 45));
				for (int a = 0; a < 10; a++)
